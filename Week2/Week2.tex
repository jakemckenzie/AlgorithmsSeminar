...
0. The first thing I will have you do is find $O(a\frac{1-r^fa
n}{1-r})$ for two cases. When $r>1$ and $r<1$ where $a$ is some function of $n$.\\\\\\\\\\\\
\newpage
...
\end{enumerate}
\newpage
\noindent F. Given two sorted arrays of n distinct integers Y[$1,\dots,n$] and Z[$1,\dots,n$]. Supposed that Y[$1,\dots,n$] is arranged in decreasing order and B[$1,\dots,n$] is arranged in increasing order.

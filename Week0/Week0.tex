...
(\textbf{Remark:} $n!$ $=$ $n(n-1)(n-2) \dots 3 \cdot 2 \cdot 1$, another way of expressing this that you may not have seen is $n! = \prod\limits_{i = 1}^{n}i$ which is just a closed form way of writing $1 \cdot 2  \cdot  3 \dots (n-2)(n-1)n$. It may help you in finding your answer but there are many ways to approximate this.)
\newpage

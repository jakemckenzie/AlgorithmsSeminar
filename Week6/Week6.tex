...
\newpage 
\noindent 10. Find the orderings of the vetex of this cube graph (Fig 8.12) for which the greedy
algorithm requires 2,3,4 colours respectively.\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
11. Is this greedy strategy optimal, that is to say does it use the minimum number of colours to colour all vertices?
\end{document}